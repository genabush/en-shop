...
export class CustomOrderConfirmationOverviewComponent implements OnInit, OnDestroy {
  order$: Observable<Order>;

  constructor(protected checkoutService: CheckoutService, private translation: TranslationService) {}
