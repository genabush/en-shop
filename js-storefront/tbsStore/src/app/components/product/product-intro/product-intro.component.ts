...
export class ProductIntroComponent implements AfterContentChecked {
  ...
  product$: Observable<Product | ICustomProduct> = this.currentProductService.getProduct();
  ...
  private getTabByLabel(label: string, tabsComponent: Element): HTMLElement {
    if (tabsComponent) {
      ...
      const h3Elements: HTMLCollectionOf<HTMLElement> = tabsComponent.getElementsByTagName('h3');
