...
describe('CustomQuantitySelectorComponent', () => {
  let itemCounterComponent: CustomQuantitySelectorComponent;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [BrowserAnimationsModule, RouterTestingModule, ReactiveFormsModule, MatSelectModule],
      declarations: [CustomQuantitySelectorComponent, MockCxTranslatePipe],
      providers: [
        { provide: Function },
  ...
  beforeEach(() => {
    ...
    itemCounterComponent.quickview = false;
    itemCounterComponent.isCart = false;
  ...
  it('should verify is value out of range', () => {
    ...
    testData.forEach(({ incomingValue, isMaxOrMinValueOrBeyond }) => {
      ...
      expect(itemCounterComponent.isMaxOrMinValueOrBeyond()).toBe(isMaxOrMinValueOrBeyond);
    });
  });
  ...
  it('should not display input when isValueChangeable is false', () => {
    ...
    expect(fixture.debugElement.query(By.css('input.counter__input'))).toBeFalsy();
    expect(fixture.debugElement.query(By.css('div.counter__input'))).toBeTruthy();
  });
  ...
  it('should display input when isValueChangeable is true', () => {
    ...
    expect(fixture.debugElement.query(By.css('input.counter__input'))).toBeTruthy();
    expect(fixture.debugElement.query(By.css('div.counter__input'))).toBeFalsy();
  });
  ...
  it('should adjust value in range', () => {
    ...
    testData.forEach(({ incomingValue, adjustedValue }) => {
      expect(itemCounterComponent.adjustValueInRange(incomingValue)).toEqual(adjustedValue);
    });
  });
  ...
  it('should try set manual change with value', () => {
    ...
    testData.forEach(({ incomingValue, adjustedValue }) => {
      ...
      expect(itemCounterComponent.adjustValueInRange).toHaveBeenCalledWith(incomingValue);
      expect(itemCounterComponent.updateValue).toHaveBeenCalledWith(adjustedValue);
    });
  });
  ...
  it('should call manualChange with value', fakeAsync(() => {
    ...
    fixture.detectChanges();
    const inputEl = fixture.debugElement.query(By.css('.counter__input'));
