...
public class ConfirmPickupAction implements CockpitAction<ConsignmentModel, Object>
{
	...
	private static final String CONFIRM_PICKUP_EVENT = "theBodyShopbackoffice.confirmpickup.event";
	...
	public ActionResult<Object> perform(final ActionContext<ConsignmentModel> ctx)
	{
		...
		if ((data != null) && (data instanceof ConsignmentModel))
		{
			...
			for (final Object element : consignmentModel.getConsignmentProcesses())
			{
				final ConsignmentProcessModel process = (ConsignmentProcessModel) element;
			...
			return new ActionResult<>(ActionResult.SUCCESS, consignmentModel);
		}
		else
		{
