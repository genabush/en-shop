...
{
	public static final String MODULE_NAME = "theBodyShop";
	public static final String MODULE_WEBROOT = "rest";
	...
	public static final String TBS_GLOBAL_STORE = "tbsGlobalStore";
	public static final String TBS_CA_STORE = "tbsCAStore";

	public static final String ISO_CODE_GLOBAL_LANGUAGE = "en";
}
