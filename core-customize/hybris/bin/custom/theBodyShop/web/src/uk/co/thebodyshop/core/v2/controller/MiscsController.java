...
import uk.co.thebodyshop.core.order.data.CardTypeDataList;
import uk.co.thebodyshop.core.storesession.data.CurrencyDataList;
import uk.co.thebodyshop.core.storesession.data.LanguageDataList;
import uk.co.thebodyshop.core.user.data.CountryDataList;
import uk.co.thebodyshop.core.user.data.TitleDataList;
...
public class MiscsController extends BaseController
{
	...
	@Resource(name = "defaultTbsStoreSessionFacade")
	private TbsStoreSessionFacade tbsStoreSessionFacade;
	...
	public LanguageListWsDTO getLanguages(@ApiFieldsParam @RequestParam(defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
		...
		dataList.setLanguages(tbsStoreSessionFacade.getFrontendDisplayLanguages());
	...
	public CurrencyListWsDTO getCurrencies(@ApiFieldsParam @RequestParam(defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
		...
		dataList.setCurrencies(tbsStoreSessionFacade.getAllCurrencies());
