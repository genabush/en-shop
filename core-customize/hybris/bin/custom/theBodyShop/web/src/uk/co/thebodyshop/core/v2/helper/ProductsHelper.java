...
public class ProductsHelper extends AbstractHelper
{
			...
			final String fields, final String searchQueryContext)
	{
		...
		if (sourceResult instanceof ProductCategorySearchPageData)
		{
			final ProductCategorySearchPageWsDTO categorySearchPageData = getDataMapper().map(sourceResult,
					ProductCategorySearchPageWsDTO.class, fields);
			categorySearchPageData
					.setAmplienceIdForThirdSlot(((ProductCategorySearchPageData) sourceResult).getAmplienceIdForThirdSlot());
			categorySearchPageData
					.setAmplienceIdForSixthSlot(((ProductCategorySearchPageData) sourceResult).getAmplienceIdForSixthSlot());
