 ...
 */
package uk.co.thebodyshop.core.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import uk.co.thebodyshop.core.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "theBodyShop.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "theBodyShop.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "theBodyShop.oauth2.tokenUrl";

	private static final String DESC = "theBodyShop.v2.description";
	private static final String TITLE = "theBodyShop.v2.title";
	private static final String VERSION = "theBodyShop.v2.version";
	private static final String LICENSE = "theBodyShop.v2.license";
	private static final String LICENSE_URL = "theBodyShop.v2.license.url";
