 ...
 */
package uk.co.thebodyshop.smarteditwebservices.config;

import static uk.co.thebodyshop.smarteditwebservices.constants.TheBodyShopsewebservicesConstants.API_VERSION;
import static uk.co.thebodyshop.smarteditwebservices.constants.TheBodyShopsewebservicesConstants.AUTHORIZATION_SCOPE_PROPERTY;
import static uk.co.thebodyshop.smarteditwebservices.constants.TheBodyShopsewebservicesConstants.AUTHORIZATION_URL;
import static uk.co.thebodyshop.smarteditwebservices.constants.TheBodyShopsewebservicesConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static uk.co.thebodyshop.smarteditwebservices.constants.TheBodyShopsewebservicesConstants.DOCUMENTATION_DESC_PROPERTY;
import static uk.co.thebodyshop.smarteditwebservices.constants.TheBodyShopsewebservicesConstants.DOCUMENTATION_TITLE_PROPERTY;
import static uk.co.thebodyshop.smarteditwebservices.constants.TheBodyShopsewebservicesConstants.LICENSE_PROPERTY;
import static uk.co.thebodyshop.smarteditwebservices.constants.TheBodyShopsewebservicesConstants.LICENSE_URL_PROPERTY;
import static uk.co.thebodyshop.smarteditwebservices.constants.TheBodyShopsewebservicesConstants.PASSWORD_AUTHORIZATION_NAME;
import static uk.co.thebodyshop.smarteditwebservices.constants.TheBodyShopsewebservicesConstants.TERMS_OF_SERVICE_URL_PROPERTY;
