...
const karma = compose(
    merge({
        junitReporter: {
            outputDir: 'jsTarget/tests/theBodyShopsmarteditcommons/junit/', // results will be saved as $outputDir/$browserName.xml
        ...
        files: lodash.concat(
            ...
            bundlePaths.test.unit.commonUtilModules, [
                ...
                'jsTarget/web/features/theBodyShopsmarteditcommons/templates.js',
                'jsTests/tests/theBodyShopsmarteditcommons/unit/specBundle.ts'
            ]
        ),
