...
<em>theBodyShopsmartedit/web/features/theBodyShopsmarteditContainer/theBodyShopsmarteditcontainermodule.ts</em>
```ts
...
export class TheBodyShopsmarteditContainer {}
```
...
SmartEdit uses Webpack, a module bundler, to bundle the application. The TypeScript source code is transpiled into JavaScript and the existing JavaScript code (ES5) is bundled as is. The following files are the Webpack configuration for the theBodyShopsmartedit:
- <em>theBodyShopsmartedit/smartedit-custom-build/generated/webpack.[dev/prod/karma].smartedit.config.js</em>
- <em>theBodyShopsmartedit/smartedit-custom-build/generated/webpack.[dev/prod/karma].smarteditContainer.config</em>

The 'theBodyShopsmartedit' layer of theBodyShopsmartedit is a bundle of theBodyShopsmartedit and theBodyShopsmarteditcommons.
The 'theBodyShopsmarteditContainer' layer of theBodyShopsmartedit is a bundle of theBodyShopsmarteditContainer and theBodyShopsmarteditcommons.
