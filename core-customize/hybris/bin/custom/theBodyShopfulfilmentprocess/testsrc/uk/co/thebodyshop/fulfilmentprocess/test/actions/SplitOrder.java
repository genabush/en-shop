 ...
 */
package uk.co.thebodyshop.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TheBodyShopFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TheBodyShopFulfilmentProcessConstants.PARENT_PROCESS);
