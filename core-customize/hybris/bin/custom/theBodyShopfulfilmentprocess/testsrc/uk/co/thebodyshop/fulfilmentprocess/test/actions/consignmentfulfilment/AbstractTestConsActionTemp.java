 ...
 */
package uk.co.thebodyshop.fulfilmentprocess.test.actions.consignmentfulfilment;

import de.hybris.platform.processengine.model.BusinessProcessModel;

import uk.co.thebodyshop.fulfilmentprocess.constants.TheBodyShopFulfilmentProcessConstants;
import uk.co.thebodyshop.fulfilmentprocess.test.actions.TestActionTemp;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, TheBodyShopFulfilmentProcessConstants.PARENT_PROCESS);
