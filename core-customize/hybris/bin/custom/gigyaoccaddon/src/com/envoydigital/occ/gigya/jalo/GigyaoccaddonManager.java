 ...
 */
package com.envoydigital.occ.gigya.jalo;
...
import com.envoydigital.occ.gigya.constants.GigyaoccaddonConstants;



/**
 * This is the extension manager of the Gigyaoccaddon extension.
 */
public class GigyaoccaddonManager extends GeneratedGigyaoccaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GigyaoccaddonManager.class.getName());
	 ...
	 */
	public static GigyaoccaddonManager getInstance()
	{
		return (GigyaoccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GigyaoccaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GigyaoccaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GigyaoccaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GigyaoccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GigyaoccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
